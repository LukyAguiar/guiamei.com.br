...
export const metadata: Metadata = {
  title: "Como pagar o DAS automaticamente | MEI/guia",
  ...
  return (
    <main>
      <PageHero
        ...
        desc="Configure o débito automático do DAS e elimine o risco de esquecer de pagar — o valor é debitado todo mês no dia 20 direto da sua conta."
      />
      ...
      <div className="max-w-3xl mx-auto px-6 pt-12 space-y-10">
        ...
        <section aria-labelledby="bancos-title">
          ...
          <div className="bg-white border border-[var(--border)] rounded-2xl overflow-hidden text-sm">
            {["Banco do Brasil", "Caixa Econômica Federal", "Bradesco", "Itaú", "Santander", "Sicoob", "Sicredi", "Banrisul", "Banco do Nordeste (BNB)", "Banco da Amazônia"].map((banco, i) => (
        ...
        <section aria-labelledby="alternativas-title">
          ...
          <div className="space-y-3">
            {["Agendamento no app do banco", "Lembrete no celular", "Calendário compartilhado"].map((item, i) => (
              <div key={i} className="flex gap-4 bg-white border border-[var(--border)] rounded-xl px-5 py-4">
                ...
                <div>
                  ...
                  <p className="text-[var(--muted)] text-sm mt-0.5">{item === "Agendamento no app do banco" ? "Configure um agendamento recorrente no app do seu banco para pagar o DAS todo dia 18 ou 19 (antes do vencimento no dia 20). Você gera o boleto uma vez, o banco paga na data programada." : item === "Lembrete no celular" ? "Configure um lembrete recorrente todo mês (por exemplo, dia 15) para emitir e pagar o DAS. Simples mas eficaz para quem não tem débito automático disponível." : "Adicione o vencimento do DAS como evento recorrente no Google Agenda ou iCalendar — com notificação com 5 dias de antecedência."}</p>
                </div>
              </div>
            ))}
          </div>
